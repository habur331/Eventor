...
class Event(models.Model):
	...
	cities = ['Абаза', 'Абакан', 'Абвиль', 'Абдулино', 'Абиджан', 'Абинск', 'Абу-Даби', 'Абуджа', 'Авиньон', 'Агидель',
			  ...
			  'Акка', 'Аккра', 'Аксай', 'Актау', 'Актюбинск (Актобе)', 'Алагир', 'Алапаевск', 'Алатырь', 'Алдан',
			  'Алейск', 'Александрия', 'Алжир', 'Александров', 'Александровск', 'Александровск-Сахалинский',
			  'Алексеевка', 'Алексин', 'Алжир', 'Алзамай', 'Алма-Ата (Алматы)', 'Альметьевск', 'Амман', 'Амстердам',
			  ...
			  'Гагарин', 'Гагра (Гагры)', 'Гай', 'Галич', 'Галле', 'Гамбург', 'Ганновер', 'Гаосюн', 'Гатчина', 'Гауда',
			  ...
			  'Дмитровск', 'Днепр (Днепропетровск)', 'Дно', 'Добрянка', 'Долгопрудный', 'Долинск', 'Домодедово',
			  ...
			  'Йена', 'Йокнеам', 'Йорк', 'Йоханнесбург', 'Йошкар-ола', 'Йоэнсуу', 'Кавасаки', 'Кадис', 'Кадников',
			  'Казань', 'Каир', 'Кайеркан', 'Калач', 'Калач-на-Дону', 'Калачинск', 'Кале', 'Кали', 'Калининград',
			  'Калининск', 'Калтан', 'Калуга', 'Калькутта', 'Кальян', 'Калязин', 'Камакура', 'Камбарка', 'Каменка',
			  'Каменногорск', 'Каменск-Уральский', 'Каменск-Шахтинский', 'Камень-на-Оби', 'Камешково', 'Камызяк',
			  'Камышин', 'Камышлов', 'Канаш', 'Кандалакша', 'Канны (Канн)', 'Канпур', 'Канск', 'Кант', 'Карабаново',
			  'Карабаш', 'Карабулак', 'Караганда', 'Каракас', 'Каракол', 'Карасук', 'Карачаевск', 'Карачев', 'Карачи',
			  'Каргат', 'Каргополь', 'Каркассон', 'Карловы Вары', 'Карлсруэ', 'Кармиэль', 'Карпинск', 'Картахена',
			  'Карталы', 'Касабланка', 'Касимов', 'Касли', 'Каспийск', 'Катав-Ивановск', 'Катайск', 'Катакюсю',
			  'Каунас', 'Кацуяма', 'Качканар', 'Кашин', 'Кашира', 'Кванджу', 'Кедровый', 'Кемерово', 'Кемь',
			  'Кесон-Сити', 'Кёльн', 'Кзыл-Орда', 'Киев', 'Кизел', 'Кизилюрт', 'Кизляр', 'Киль', 'Кимовск', 'Кимры',
			  'Кингисепп', 'Кинель', 'Кинешма', 'Киншаса', 'Киреевск', 'Киркенес', 'Киото', 'Киренск', 'Киржач',
			  'Кириллов', 'Кириши', 'Киров', 'Кировград', 'Кировоград', 'Кирово-Чепецк', 'Кировск', 'Кировск', 'Кирс',
			  'Кирсанов', 'Кирьят-Шмона', 'Киселёвск', 'Кисловодск', 'Кито', 'Кишинев', 'Клайпеда', 'Кливленд',
			  'Климовск', 'Клин', 'Клинцы', 'Княгинино', 'Кобе', 'Ковдор', 'Ковентри', 'Ковров', 'Ковылкино', 'Когалым',
			  'Кодинск', 'Козельск', 'Козловка', 'Козьмодемьянск', 'Коканд', 'Кола', 'Кологрив', 'Коломна', 'Колпашево',
			  'Колпино', 'Кольчугино', 'Коммунар', 'Компьень', 'Комсомольск', 'Комсомольск-на-Амуре', 'Конаково',
			  'Конакри', 'Кондопога', 'Кондрово', 'Константиновск', 'Копейск', 'Копенгаген', 'Кораблино', 'Кордова',
			  'Кореновск', 'Коркино', 'Королёв', 'Короча', 'Корсаков', 'Коряжма', 'Костерёво', 'Костомукша', 'Кострома',
			  'Котельники', 'Котельниково', 'Котельнич', 'Котлас', 'Котово', 'Котовск', 'Кохма', 'Краков', 'Красавино',
			  'Красноармейск', 'Красноармейск', 'Красновишерск', 'Красногорск', 'Краснодар', 'Красное Село',
			  'Краснозаводск', 'Краснознаменск', 'Краснознаменск', 'Краснокаменск', 'Краснокамск', 'Краснослободск',
			  'Краснослободск', 'Краснотурьинск', 'Красноуральск', 'Красноуфимск', 'Красноярск', 'Красный Кут',
			  'Красный Сулин', 'Красный Холм', 'Кремёнки', 'Кронштадт', 'Кропоткин', 'Крымск', 'Кстово', 'Куала-Лумпур',
			  'Кубинка', 'Кувандык', 'Кувшиново', 'Кудымкар', 'Кузнецк', 'Кулебаки', 'Кумертау', 'Кунгур', 'Куньмин',
			  'Купино', 'Курган', 'Курганинск', 'Курильск', 'Курлово', 'Куровское', 'Курск', 'Куртамыш', 'Курчатов',
			  'Куса', 'Кустанай', 'Кушва', 'Кызыл', 'Кыштым', 'Кяхта', 'Ла-Пас', 'Лабинск', 'Лабытнанги', 'Лагань',
			  'Лагос', 'Лаишево', 'Лакинск', 'Лакхнау', 'Лангепас', 'Ланьчжоу', 'Лаc-Вегас', 'Лахденпохья', 'Лахор',
			  'Лебедянь', 'Лейден', 'Лейпциг', 'Лелистад', 'Ле-Ман', 'Лениногорск', 'Ленинск', 'Ленинск-Кузнецкий',
			  'Ленск', 'Лермонтов', 'Лесной', 'Лесозаводск', 'Лесосибирск', 'Ливерпуль', 'Ливны', 'Лидс',
			  'Ликино-Дулёво', 'Лилль', 'Лима', 'Лимассол', 'Лимож', 'Линкопинг', 'Линц', 'Лион', 'Липецк', 'Липки',
			  'Лиски', 'Лиссабон', 'Лихославль', 'Лобня', 'Лодейное Поле', 'Лозанна', 'Ломоносов', 'Лондон',
			  'Лос-Анджелес', 'Лосино-Петровский', 'Луанда', 'Лувен', 'Луга', 'Луганск', 'Лудхияна', 'Луза', 'Лукоянов',
			  'Луховицы', 'Луцк', 'Лысково', 'Лысьва', 'Лыткарино', 'Львов', 'Любань', 'Люберцы', 'Любим', 'Люксембург',
			  'Люцерн', 'Лянтор', 'Мааслуис', 'Маастрихт', 'Магадан', 'Магас', 'Магдебург', 'Магнитогорск', 'Мадрас',
			  'Мадрид', 'Майкоп', 'Майский', 'Майами-Бич', 'Макарьев', 'Макушино', 'Малага', 'Малая Вишера', 'Малгобек',
			  'Малмыж', 'Малоархангельск', 'Малоярославец', 'Мамадыш', 'Мамоново', 'Манаус', 'Манила', 'Мантурово',
			  'Манчестер', 'Мапуту', 'Маракайбо', 'Мариинск', 'Мариинский Посад', 'Маркс', 'Марракеш', 'Марсель',
			  'Маршалл', 'Махачкала', 'Мглин', 'Мегион', 'Медан', 'Медвежьегорск', 'Медельин', 'Медногорск', 'Медынь',
			  'Межгорье', 'Междуреченск', 'Мезень', 'Меленки', 'Мелеуз', 'Мельбурн', 'Менделеевск', 'Мензелинск',
			  'Мехико', 'Мешхед', 'Мещовск', 'Миасс', 'Мидделбург', 'Микунь', 'Милан', 'Миллерово', 'Минеральные Воды',
			  'Минск', 'Минусинск', 'Миньяр', 'Мирный', 'Мирный', 'Михайлов', 'Михайловка', 'Михайловск', 'Михайловск',
			  ...
			  'Отрадный', 'Оттава', 'Оха', 'Оханск', 'Очёр', 'Ош', 'Павлово', 'Павловск (Лен.обл.)', 'Павловск',
			  ...
			  'Сортавала', 'Сосенский', 'Сосновка', 'Сосновоборск', 'Сосновый Бор', 'Сосногорск', 'София', 'Сочи',
			  ...
			  'Сухой Лог', 'Сухум (Сухуми)', 'Сходня', 'Сызрань', 'Сыктывкар', 'Сысерть', 'Сычёвка', 'Сянган',
			  'Сясьстрой', 'Тавда', 'Таганрог', 'Тайбэй', 'Тайга', 'Тайшет', 'Тайюань', 'Талас', 'Талдом', 'Талица',
			  'Таллин (Таллинн)', 'Талнах', 'Тамбов', 'Тампере', 'Таншань', 'Тара', 'Тарко-Сале', 'Тарту', 'Таруса',
	...
	def save(self, *args, **kwargs):
		if not self.pk:
			...
			N, S = (j['response']['GeoObjectCollection']['featureMember'][0]['GeoObject']['boundedBy']['Envelope']['lowerCorner']).split(' ')
			N = float(N)
			S = float(S)
			N1, S1 = (j['response']['GeoObjectCollection']['featureMember'][0]['GeoObject']['boundedBy']['Envelope']['upperCorner']).split(' ')
			N1 = float(N1)
			S1 = float(S1)
			N += N1
			S += S1
			...
			with open('events/static/events/data.json', 'r') as file:
				...
				j['features'].append(
					{"type": "Feature", "id": Counter, "geometry": {"type": "Point", "coordinates": [S, N]},"properties": {"balloonContentHeader": "<font size=3><b><a target=\'_blank\' href=\'https://yandex.ru\'>www.vk.com</a></b></font>","hintContent": self.event_name}})
